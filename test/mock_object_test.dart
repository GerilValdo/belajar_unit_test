import 'package:belajar_unit_test/book.dart';
...
void main(){
  group('BookService', (){
    ...
    test('Find book by id Geril123', (){ //contoh menggunakan Argument Matcher 'argThat' dan 'any'
      when(bookRepository.findById(argThat(startsWith('Geril'))))
        .thenReturn(Book('Geril123', 'Tutorial Dart', 100000));

      var book = bookService.find('Geril123');
      expect(book, equals(Book('Geril123', 'Tutorial Dart', 100000)));
